;; (add-to-list 'load-path "/net/fantasia/home/zhanxw/temp/benchmark-init-el/")
...
;; Tune Emacs GC to start every 20MB
...
;;               '("~/emacs/snippets"    ;; personal collection
;;                 )))
;; (yas-global-mode 1)
(use-package yasnippet
  ...
  :config
  (setq yas-snippet-dirs
          (append '("~/emacs/snippets"    ;; personal collection (default snippet location)
                    )
                  yas-snippet-dirs
                  ))
  (yas-global-mode 1)
...
;; it hides and shows blocks of text. In particular, it hides
;; balanced-expression code blocks and multi-line comment blocks.
...
;; 
(add-to-list 'load-path "~/emacs/third/ace-jump-mode")
(autoload
  'ace-jump-mode
  "ace-jump-mode"
...
;; ;; Tempo seems to be an old way than yasnippet
