...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dna-mode" '("dna-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dna-primer" '("dna-primer")))
